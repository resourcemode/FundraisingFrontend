...
class CreditCardUrlGeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testWhenTestModeIsEnabled_urlPassesProperParameter() {
		...
		$this->assertSame(
			...
			'paytext=Ich+spende+einmalig&mp_user_firstname=Kai&mp_user_surname=Nissen&sid=1234567&' .
	...
	public function donationProvider() {
		return [
			...
			[
				'https://credit-card.micropayment.de/creditcard/event/index.php?project=wikimedia&bgcolor=CCE7CD&' .
					'paytext=Ich+spende+monatlich&mp_user_firstname=Kai&mp_user_surname=Nissen&sid=1234567&' .
			...
			[
				'https://credit-card.micropayment.de/creditcard/event/index.php?project=wikimedia&bgcolor=CCE7CD&' .
					...
					'token=my_access_token&utoken=my_update_token&amount=1250&theme=wikimedia',
				'Kai',
				'Nissen',
